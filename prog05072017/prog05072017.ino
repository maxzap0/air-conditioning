...
#define dac_mode 'SPI'  //режим вывода на цифро-аналог преобразователь (I2C или SPI)
...
void loop(){
  ...
  switch (read_dip()) {
      case 7 :                                   //Рабочий режим
          work();
        break;
      case 6 :                                   //настройка 1го холодного вентилятора
        fan_setting1();
        break;
      case 5:                                    //настройка 2го холодного вентилятора
        fan_setting2();
        break;
      case 2:                                    //Режим индикации ошибок
        err();
        break;
      case 3:                                    //настройка 1го горячего вентилятора
        fan_setting3();
        break;
      case 4:                                    //настройка 2го горячего вентилятора
        fan_setting4();
        break;
...
byte read_dip () {
  return (0b111 & read_pcf(pcf5)); //считываем первые три байта pcf
  //
}  
...
void spi_dac_write(uint8_t b1, uint8_t b2, uint8_t b3) {
}
/*

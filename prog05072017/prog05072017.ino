...
<<<<<<< HEAD
/*Переменные замера оборотов*/
int *rpm_fan = new int[8];


/* Временные переменные *//////////////////////////////////////////////////////////////////////////////////////////  
=======
>>>>>>> 0b6cd91474a4047c3bf2530795c1748cd0a3a585
...
void loop(){
  ...
  /*freq(&rpm_fan, &PINB, 0b11000, 2, 1);
  freq(&rpm_fan, &PINC, 0b0, 3, 1);
  freq(&rpm_fan, &PINC, 0b10000, 4, 1);*/
